...
{
    if (row1 > array.GetLength(0) || row2 > array.GetLength(0)) return array;
    else
    for (int j = 0; j < array.GetLength(1); j++)
    {
...
// Console.Write("Please enter row index to replace -> ");
// int r1 = Convert.ToInt32(Console.ReadLine());
// Console.Write("Please enter row index to replace with -> ");
...
//отталкиваться от главной диагонали - на которой элементы меняться не будут

int[,] DiagonalReverseArray(int[,] array)
{
    if (array.GetLength(0) != array.GetLength(1))
    {
        Console.WriteLine("Impossible to reverse array, array should be square");
        return array;
    }
    else 
    {
...
//изменить - условие - не удалять а поставить нули на строке и столбце где находится минимальный элемент
