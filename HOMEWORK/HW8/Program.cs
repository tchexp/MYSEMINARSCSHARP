...
int[,,] AppendArrayRandomUnique(int[,,] array, int pos, int minValue, int maxValue)
{
    ...
    else
    {
        for (int i = 0; i < pos; i++)
        {
            if (array[i / (array.GetLength(1) * array.GetLength(2))
                    , i % (array.GetLength(1) * array.GetLength(2)) / array.GetLength(2)
                    , i % (array.GetLength(1) * array.GetLength(2)) % array.GetLength(2)
                     ]
                     ==
                array[pos / (array.GetLength(1) * array.GetLength(2))
                    , pos % (array.GetLength(1) * array.GetLength(2)) / array.GetLength(2)
                    , pos % (array.GetLength(1) * array.GetLength(2)) % array.GetLength(2)
                     ]
                     ||
                array[pos / (array.GetLength(1) * array.GetLength(2))
...
myArray[0, 0, 0] = new Random().Next(11, 99 + 1);//костыль, метод ниже заполняет с 1 позиции 
myArray = AppendArrayRandomUnique(myArray, 0, 11, 99);
Show3DArrayWithIndex(myArray);


// Console.WriteLine($"layers {myArray.GetLength(0)}, rows {myArray.GetLength(1)}, columns {myArray.GetLength(2)}");
// Console.WriteLine($"layer {23 / (myArray.GetLength(1) * myArray.GetLength(2))}");
// Console.WriteLine($"row {(23 - ((23 / (myArray.GetLength(1) * myArray.GetLength(2)))) * myArray.GetLength(1) * myArray.GetLength(2)) / myArray.GetLength(2)}");
// Console.WriteLine($"column {(23 - ((23 / (myArray.GetLength(1) * myArray.GetLength(2)))) * myArray.GetLength(1) * myArray.GetLength(2)) % myArray.GetLength(2)}");
// int where = 11;
// Console.WriteLine($"where = {where}");
// Console.WriteLine($"layer {where / (myArray.GetLength(1) * myArray.GetLength(2))}");
// Console.WriteLine($"row2* {where % (myArray.GetLength(1) * myArray.GetLength(2)) / myArray.GetLength(2)}");
// Console.WriteLine($"row {(where - ((where / (myArray.GetLength(1) * myArray.GetLength(2)))) * myArray.GetLength(1) * myArray.GetLength(2)) / myArray.GetLength(2)}");
// Console.WriteLine($"column {(where - ((where / (myArray.GetLength(1) * myArray.GetLength(2)))) * myArray.GetLength(1) * myArray.GetLength(2)) % myArray.GetLength(2)}");
// Console.WriteLine($"column* {where % (myArray.GetLength(1) * myArray.GetLength(2)) % myArray.GetLength(2)}");

//Show2DArray(AppendArrayRandom(myArray, 1, 0, 9));

// Console.WriteLine(array[pos / array.GetLength(0), pos % array.GetLength(0)]);
